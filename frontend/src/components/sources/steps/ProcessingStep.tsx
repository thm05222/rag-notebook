          ...
          <Controller
            ...
            render={({ field }) => (
              <label className="flex items-start gap-3 cursor-pointer p-3 rounded-md hover:bg-muted">
                ...
                />
                <div className="flex-1">
                  <span className="text-sm font-medium block">Build PageIndex for reasoning-based search</span>
                  <p className="text-xs text-muted-foreground mt-1">
                    Creates a hierarchical index for better search in long documents. Best for financial reports, legal documents, and technical manuals.
                  </p>
                </div>
              </label>
            )}
