...
async def get_settings():
    ...
    try:
        ...
        return SettingsResponse(
            ...
            default_context_mode=settings.default_context_mode,
        )
...
async def update_settings(settings_update: SettingsUpdate):
    ...
    try:
        ...
        if settings_update.default_context_mode is not None:
            from typing import Literal, cast
            settings.default_context_mode = cast(
                Literal["full", "off", "insights"],
                settings_update.default_context_mode
            )
